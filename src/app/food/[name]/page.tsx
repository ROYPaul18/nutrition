...
import { IFood, IMacronutrientData } from "../types/types";
...
const FoodPage = ({ params }: { params: { name: string } }) => {
  ...
  return (
    <>
      {!isLoading && food && macroNutriment.length > 0 ? (
        <div className="p-8 text-white">
          ...
          />
          <h1 className="mb-6 text-5xl font-bold leading-tight tracking-tight text-white md:text6xl lg:text-7xl">
            {food.name}
          </h1>
