...
import {IFoodReduced, IFood} from "../types/types"
    ...
    <>  
      {!isLoading ? (
        <div className="min-h-screen text-white flex flex-col items-center justify-center p-6">
          <h1 className="text-5xl font-extrabold"> Welcome to <span className="title_colored">NutriSpark</span></h1>
          <p className="text-lg mb-8 text-center max-w-2xl"> Discover the nutritional values of your favorite foods. Use the seath below to get started.</p>
